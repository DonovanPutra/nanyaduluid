                        ...
                        <x-form action="{{ route('threads.store') }}">
                            <div class="space-y-8">
                                ...
                                <div>
                                    ...
                                    <select name="tags[]" id="tags" x-data="{}" x-init="window.choices($el)" class="w-full text-sm border-gray-300 rounded-md shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50" multiple>
                                        @foreach ($tags as $tag)
                                ...
                                <div>
                                    ...
                                    <textarea name="body" id="body" class="w-full text-sm border-gray-300 rounded-md shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50">{{ old('body') }}</textarea>
